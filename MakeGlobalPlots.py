...
def MakeGlobalAUROC_KSPlots(model_dirs, plot_dir):
    ...
    PerformancePlotter.plot_background_rejection_JS(perfdicts, outpath = plot_dir, colorquant = "lambda")
...
def main():
    ...
    to_combine = [
        "dist_clf_Hbb", "dist_clf_ttbar", "dist_clf_Wjets", "dist_clf_Zjets",
        "dist_mBB_Zjets_50.0", "dist_mBB_ttbar_50.0", "dist_mBB_Hbb_50.0", "dist_mBB_Wjets_50.0",
        "dist_mBB_Zjets_25.0", "dist_mBB_ttbar_25.0", "dist_mBB_Hbb_25.0", "dist_mBB_Wjets_25.0",
        "dist_dRBB_Zjets_50.0", "dist_dRBB_ttbar_50.0", "dist_dRBB_Hbb_50.0", "dist_dRBB_Wjets_50.0",
        "dist_dRBB_Zjets_25.0", "dist_dRBB_ttbar_25.0", "dist_dRBB_Hbb_25.0", "dist_dRBB_Wjets_25.0",
        "dist_pTB1_Zjets_50.0", "dist_pTB1_ttbar_50.0", "dist_pTB1_Hbb_50.0", "dist_pTB1_Wjets_50.0",
        "dist_pTB1_Zjets_25.0", "dist_pTB1_ttbar_25.0", "dist_pTB1_Hbb_25.0", "dist_pTB1_Wjets_25.0",
        "dist_pTB2_Zjets_50.0", "dist_pTB2_ttbar_50.0", "dist_pTB2_Hbb_50.0", "dist_pTB2_Wjets_50.0",
        "dist_pTB2_Zjets_25.0", "dist_pTB2_ttbar_25.0", "dist_pTB2_Hbb_25.0", "dist_pTB2_Wjets_25.0"
    ]
    
    overlays = [
        None, None, None, None,
        "dist_mBB_Zjets_100.0", "dist_mBB_ttbar_100.0", "dist_mBB_Hbb_100.0", "dist_mBB_Wjets_100.0",
        "dist_mBB_Zjets_100.0", "dist_mBB_ttbar_100.0", "dist_mBB_Hbb_100.0", "dist_mBB_Wjets_100.0",
        "dist_dRBB_Zjets_100.0", "dist_dRBB_ttbar_100.0", "dist_dRBB_Hbb_100.0", "dist_dRBB_Wjets_100.0",
        "dist_dRBB_Zjets_100.0", "dist_dRBB_ttbar_100.0", "dist_dRBB_Hbb_100.0", "dist_dRBB_Wjets_100.0"
        "dist_pTB1_Zjets_100.0", "dist_pTB1_ttbar_100.0", "dist_pTB1_Hbb_100.0", "dist_pTB1_Wjets_100.0",
        "dist_pTB1_Zjets_100.0", "dist_pTB1_ttbar_100.0", "dist_pTB1_Hbb_100.0", "dist_pTB1_Wjets_100.0",
        "dist_pTB2_Zjets_100.0", "dist_pTB2_ttbar_100.0", "dist_pTB2_Hbb_100.0", "dist_pTB2_Wjets_100.0",
        "dist_pTB2_Zjets_100.0", "dist_pTB2_ttbar_100.0", "dist_pTB2_Hbb_100.0", "dist_pTB2_Wjets_100.0"
    ]

    for cur, cur_overlay in zip(to_combine, overlays):
        print("generating plots for {}".format(cur))
