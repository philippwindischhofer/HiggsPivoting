...
def create_job_script(model_dir, script_dir, training_data_path):
    ...
    with open(script_path, "w") as outfile:
        ...
        outfile.write("python /home/windischhofer/HiggsPivoting/ExportAnalysisRegionHistograms.py --data " + training_data_path + " --model_dir " + model_dir + " --out_dir " + model_dir + " --test_size 0.5 " + " > " + os.path.join(model_dir, "fitjob.log") + "\n")
