...
from training.TFSessionManager import TFSessionManager
...
def TrainAdversarialModel(infile_path, outdir, verbose_statistics = False):
    ...
    from training.DataFormatters import only_2j
    from training.BatchSamplers import sample_from_TrainingSamples

    trainer = AdversarialModelTrainer(mod, data_formatter = only_2j, batch_sampler = sample_from_TrainingSamples)
    ...
    trainer_2 = AdversarialModelTrainer(mod_2, data_formatter = only_2j, batch_sampler = sample_from_TrainingSamples)
