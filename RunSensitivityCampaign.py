...
def create_job_script(model_dir, script_dir, training_data_path):
    ...
    with open(script_path, "w") as outfile:
        ...
        outfile.write("python /home/windischhofer/HiggsPivoting/EvaluateExpectedSensitivity.py --data " + training_data_path + " --plot_dir " + plot_dir + " --model_dir " + model_dir + " > " + os.path.join(model_dir, "sensjob.log") + "\n")
