...
class AdversarialEnvironment(TFEnvironment):
    ...
    def build(self):
        ...
        with self.graph.as_default():
            ...
            #float(self.global_pars["adam_clf_lr"])
            ...
            #float(self.global_pars["adam_adv_lr"])
            ...
            # float(self.global_pars["adam_clf_adv_lr"])
