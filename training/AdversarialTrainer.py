...
class AdversarialTrainer(Trainer):
    ...
    def train(self, env, number_batches, df_sig, df_bkg, nuisances):
        ...
        for batch in range(self.training_pars["pretrain_batches"]):
            ...
            env.train_adversary(data_step = data_batch, nuisances_step = nuisances_batch, labels_step = labels_batch)
            env.dump_loss_information(data = data_batch, nuisances = nuisances_batch, labels = labels_batch)
