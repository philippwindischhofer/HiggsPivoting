...
class CutBasedCategoryFiller:
    ...
    # dRBB < 1.8
    @staticmethod
    def create_low_MET_category(process_events, process_aux_events, process_weights, process_names, nJ = 2, cuts = {"MET_cut": 192, "dRBB_highMET_cut": 1.3, "dRBB_lowMET_cut": 5.0}):
    ...
    # dRBB < 1.2
    @staticmethod
    def create_high_MET_category(process_events, process_aux_events, process_weights, process_names, nJ = 2, cuts = {"MET_cut": 192, "dRBB_highMET_cut": 1.3, "dRBB_lowMET_cut": 5.0}):
